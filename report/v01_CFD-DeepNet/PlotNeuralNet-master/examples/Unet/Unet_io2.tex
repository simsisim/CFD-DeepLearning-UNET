...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% conv1_1,conv1_2
\node[canvas is zy plane at x=0] (temp) at (-3,0,0) {\includegraphics[width=8cm,height=5cm]{boundaryConds-13.png}};

\node[canvas is xy plane at z=0] (text1) at (-3.5,-4, 2) {\Large{\textbf{BOUNDARY COND.}}};
...
\pic[shift={(0,0,0)}] at (ucr4-east) {RightBandedBox={name=cat4,%
        xlabel={{"",""}},fill={rgb:white,1;black,3},bandfill={rgb:white,1;black,2},opacity=0.2,height=16,width=6,depth=16}};    
...
\pic[shift={(0,0,0)}] at (ucr3-east) {RightBandedBox={name=cat3,%
        xlabel={{"",""}},fill={rgb:white,1;black,3},bandfill={rgb:white,1;black,2},opacity=0.2,height=25,width=4.5,depth=25}};
...
\pic[shift={(0,0,0)}] at (ucr2-east) {RightBandedBox={name=cat2,%
        xlabel={{"",""}},fill={rgb:white,1;black,3},bandfill={rgb:white,1;black,2},opacity=0.2,height=32,width=3.5,depth=32}};    
...
\pic[shift={(0,0,0)}] at (ucr1-east) {RightBandedBox={name=cat1,%
        xlabel={{"",""}},fill={rgb:white,1;black,3},bandfill={rgb:white,1;black,2},opacity=0.2,height=40,width=2.5,depth=40}};  
...
\pic[shift={(0.75,0,0)}] at (ucr1a-east) {Box={name=out1,%
        ,fill=\SoftmaxColor,height=50.75,width=1,depth=40}};
\pic[shift={(1.0,0,0)}] at (ucr1a-east) {Box={name=out2,%
        ,fill=\SoftmaxColor,height=50,width=1,depth=40}};
        
\pic[shift={(-1.3,2.525,0)}] at (out1-north) {Ball={name=elt2,%
        fill=\SumColor,opacity=0.6,%
        radius=2.5,logo=$\times$}}; 
        
\node[canvas is zy plane at x=0] (temp2) at (37, 4,0) {\includegraphics[width=8cm,height=5cm]{predx-Vel_13.png}};   
\node[canvas is zy plane at x=0] (temp2) at (37,-2,0) {\includegraphics[width=8cm,height=5cm]{predy-Vel_13.png}};  
\node[canvas is xy plane at z=0] (text1) at (37,-5.5,2) {\Large{\textbf{x-, y-VELOCITY}}};  

\node[canvas is xy plane at z=0] (text1) at (37,16, 20) {\Large{\textbf{SET BOUNDARY COND. TO 0}}};   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Draw connections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\draw [connection]  (ucr1a-east) -- node {\midarrow} (out1-west);
%\draw [connection]  (ucr1a-east) -- node {\midarrow} (out2-west);
%\draw [connection]  (-3.0,0,0) -- node {\midarrow} (out1-west);
...
\path (out1-south)  -- (out1-north)  coordinate[pos=1.25] (out1-top)  ;
\path (-3.0,0,0) --  (-3.0, 6.0, 0.0) coordinate[pos=1.25] (image-top) ;
...
%
\draw [copyconnection]  (-3.,0.0,0)  
-- node {\copymidarrow}(image-top)
-- node {\copymidarrow}(out1-top)
-- node {\copymidarrow} (out1-north);
